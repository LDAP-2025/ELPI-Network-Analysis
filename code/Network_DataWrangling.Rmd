...
##  Read in Data Wave 1 
```{r}
raw_data_wave1 <- read_dta("unzipped_data/Evaluaciones_2010.dta")
...
# Read in Data Wave 2
```{r}
raw_data_wave2 <- read_dta("unzipped_data/Evaluaciones_2012.dta")
...
#Read in Data Wave 3
```{r}
raw_data_wave3 <- read_sav("unzipped_data/Evaluaciones_2017.sav")
...
```{r}
data_SU_W1 <- read_dta("unzipped_data/Entrevistada_2010.dta")

#Filter data to onky include participant identifier "folio" and columns with alcohol use report "G9: Asking During pregnancy did you consume an alcoholic beverage?
