...
categories <- c("Emotional_Reactivity", "Anxiety_or_Depression", "Somatic_Complaints","Social_Problems", "Sleep_Problems", "Attention_Issues", "Agressive_Conduct")
...
# Expand the top margin to make room for the title
par(mar = c(5, 4, 8, 2))  # Increase top margin (third value)
...
graph_smfq <- qgraph(network_smfq, layout = 'spring', labels = vars, 
                     ...
                     label.norm = '000000')
title("Ising Model Comparison:\nM2 Omega Group Equality Constrains", cex.main = 0.8, line = 6)
...
```
Interpretation
- Temperature is and indicator of network stability, with higher values indicating less symptom alignment and lower values indicating greater variability. 
-Previous literature has shown temperature of depression symptom networks decrease across adolescence 
-These results show alligning findings as across the 3 waves the CBCL scores became more characteristically stable as measured through network temperature 
