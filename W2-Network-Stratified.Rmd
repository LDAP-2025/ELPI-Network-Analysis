...
symptom_data2SA <- W1_cbcl_alcohol_use  %>% select(-folio, -g9) #filtering participant ID 
...
# Step 1 Create Correlation matrix (excluding 'folio')
symptom_data2SN <- W1_cbcl_no_alcohol  %>% select(-folio, -g9) #filtering participant ID 
